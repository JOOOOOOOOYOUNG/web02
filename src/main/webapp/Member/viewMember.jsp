    ...
    <div class="container">
     ...
     <h2 class="text-center">회원정보 조회</h2>
      ...
      <form>
        ...
        <div class="col-md-6">
          <a href="${ctxPath}/member/modifyMember.do?id=${member.id}" class="btn btn-outline-info btn-sm m-1">수정</a> 
          <a href="${ctxPath}/member/deleteMember.do?id=${member.id}" class="btn btn-outline-info btn-sm m-1" id="delBtn">삭제</a>
          <input type="hidden" value="${member.id}" id="memberId">
          <input type="hidden" value="${ctxPath}" id="path">
        </div>
        <div class="col-md-2">
          <a href="${ctxPath}/member/listMember.do" class="btn btn-outline-primary btn-sm m-1">목록</a>
        </div>
        </div>
