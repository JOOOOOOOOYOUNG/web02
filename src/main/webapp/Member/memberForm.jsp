...
<body>
 ...
 <div class="main">
    <div class="container">
      ...
      <form action="${ctxPath}/tmember.insert.do" method="post" id="updateForm">
      ...
      <div class="mb-3">
        ...
        <a href="${ctxPath}/tmember/list.do" class="btn btn-outline-primary">목록</a>
      </div>
