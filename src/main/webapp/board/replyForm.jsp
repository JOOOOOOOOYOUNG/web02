    ...
    부모 글번호: ${parentNO}
      <div class="main">
        <div class="container mt-3">
           <form action="${ctxPath}/boardlist/addReply.do" enctype="multipart/form-data" method="post"> <!-- 업로드(이미지파일) 기능이 포함된 form -->
       <!--   <form action="${ctxPath}/boardlist/insert.do" method="post"> -->
          ...
          <div class="w-75 m-auto d-flex justify-content-center">
            <div class="w-75 d-flex justify-content-between">
              <div>
              <button type="submit" class="btn btn-secondary btn-sm">답글반영하기</button>
              <button type="button" onClick="list()" class="btn btn-secondary btn-sm">취소</button>
              </div>
              <div>
